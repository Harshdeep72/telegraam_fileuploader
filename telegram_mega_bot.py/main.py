...
TELEGRAM_BOT_TOKEN = os.environ.get('7298924629:AAGLM1sKKeDpsJXBfwGKW-ZW7PFNzkP6yAE')

# MEGA account credentials
MEGA_EMAIL = os.environ.get('nunislive@gmail.com')
MEGA_PASSWORD = os.environ.get('M32298@1wF')
